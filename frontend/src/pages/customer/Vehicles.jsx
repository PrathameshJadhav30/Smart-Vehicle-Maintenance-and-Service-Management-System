        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-6 flex justify-end space-x-3">
            <button
              ...
              className="px-4 py-2 rounded-lg transition-all duration-200 bg-white border border-gray-300 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer"
            >
              Cancel
            </button>
            <button
              type="submit"
              className="px-4 py-2 rounded-lg transition-all duration-200 bg-blue-600 hover:bg-blue-700 text-white border-transparent focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 cursor-pointer"
            >
              Add Vehicle
            </button>
          </div>
