          ...
          <div className="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="text-center md:text-left flex-1">
                ...
                <p className="text-lg text-gray-600 mt-1">{user?.email || 'N/A'}</p>
                  ...
                  <div className="bg-gray-50 rounded-xl p-6 hover:bg-gray-100 transition-all duration-300 shadow-sm border border-gray-100">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-lg font-semibold text-gray-900">{user?.email || 'N/A'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-6 hover:bg-gray-100 transition-all duration-300 shadow-sm border border-gray-100">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-lg font-semibold text-gray-900">{user?.phone || 'N/A'}</p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gray-50 rounded-xl p-6 hover:bg-gray-100 transition-all duration-300 shadow-sm border border-gray-100">
                    <div className="flex items-start">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="mt-1 text-lg font-semibold text-gray-900">{user?.address || 'N/A'}</p>
                      </div>
                    </div>
                  </div>
                </div>
