...
const MechanicDashboard = () => {
      ...
      return (
        <div className="bg-gray-100 rounded-lg p-2">
          <svg className="h-6 w-6 text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.996.608 2.296.07 2.572-1.065z" />
  ...
  return (
    <DashboardLayout role="mechanic" title="Mechanic Dashboard">
      <div className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 lg:grid-cols-3 mb-8">
            ...
            <div className="bg-white overflow-hidden shadow rounded-xl hover:shadow-lg transition-shadow duration-300 cursor-pointer">
              <div className="p-6">
              ...
              <div className="bg-gray-50 px-6 py-4 border-t border-gray-100">
                <div className="text-sm">
                  <button 
                    ...
                    className="font-medium text-blue-600 hover:text-blue-800 transition-colors duration-200 flex items-center cursor-pointer"
                  >
                    View all bookings
            ...
            <div className="lg:col-span-2">
              <div className="bg-white shadow rounded-xl overflow-hidden">
                <div className="px-6 py-5 border-b border-gray-100 sm:flex sm:items-center sm:justify-between">
                  ...
                  <button 
                    onClick={() => navigate('/mechanic/bookings')}
                    className="mt-3 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-lg shadow-sm text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 sm:mt-0 cursor-pointer"
                  >
                    View all
                  </button>
                </div>
