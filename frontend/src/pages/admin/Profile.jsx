...
const AdminProfilePage = () => {
  ...
  const validateProfileForm = () => {
    ...
    // Validate address if provided (length check)
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:justify-between md:items-center mb-8 gap-6">
          ...
          <div className="text-center flex-1 md:mx-auto">
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900">Admin Profile</h1>
            <p className="mt-2 text-gray-600">Manage your admin account settings and preferences</p>
          </div>
        </div>
          ...
          <div className="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
            <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
              ...
              <div className="text-center md:text-left flex-1 min-w-0">
                <h2 className="text-2xl font-bold text-gray-900 truncate">{user?.name || 'Admin'}</h2>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        onChange={handleInputChange}
                        className={`mt-1 block w-full border ${formErrors.address ? 'border-red-500' : 'border-gray-300'} rounded-xl shadow-sm py-3 px-4 pr-16 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition duration-200`}
                      />
                      <div className="absolute inset-y-0 right-0 flex items-center pr-3 pointer-events-none">
                        <span className="text-sm text-gray-500">
        ...
        <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
          <div className="px-6 py-5 border-b border-gray-100 bg-gradient-to-r from-blue-50 to-indigo-50">
            ...
            <p className="mt-1 text-gray-600">
              Update your password regularly to keep your admin account secure.
            </p>
          </div>
